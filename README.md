...
Je suis **Falandy JEAN**, étudiant en informatique à l'**École Supérieure d'Infotronique d'Haïti (ESIH)**, développeur backend et passionné par l'**intelligence artificielle** et le **trading algorithmique**. Actuellement, je préside le Club **Numédia** de l'ESIH, une initiative visant à promouvoir le numérique et le multimédia auprès des étudiants.
...
- Génération assistée de CV et lettres de motivation (`Resous Travay`)
- Assistant local intelligent pour démarches et informations quotidiennes (`Info Lokal`)

#### 🧰 Technologies utilisées :
- **FastAPI** – API REST performante en Python
- **Hugging Face** – NLP et modèles LLM personnalisés
